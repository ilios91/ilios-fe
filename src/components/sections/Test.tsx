  ...
  return (
    <section id="about" className="h-[640p] w-[90%] mx-auto relative">
      <div className="flex items-center w-full gap-x-10 mt-24 mb-8">
        <div className="w-[604px] max-w-[604px] h-[627.47px] max-h-[627.47px] bg-red-500">
          <Image 
            src={AboutImage} 
            alt="about-image" 
            fill={true}
            priority
            objectFit="contain"
            sizes="(max-width: 604px)"
          />
          
        </div>
        <div className="w-[584px]">
          <h2 className="text-[36px] font-bold text-main-black leading-8"> About us </h2>
